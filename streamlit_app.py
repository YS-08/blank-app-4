...
with tab1:
    ...
    st.markdown(
        ...
        <ol>
            <li><b>주요 연구 결과</b><br>
                해수온 상승과 산호초 백화 현상 간의 높은 상관관계: 미국해양대기청(NOAA)의 자료에 따르면, 해수온이 평년보다 1~2℃ 이상 상승할 경우 산호초 백화 현상이 급격하게 발생합니다. 특히 1998년과 2016년과 같이 해수온이 평년 대비 1~2℃ 높게 유지된 시기에는 전 지구적 백화 현상이 광범위하게 관측되었습니다. 이는 해수온 상승이 산호 생태계 붕괴를 직접적으로 유발하는 핵심 요인임을 보여줍니다.<br>
                산호초 백화 현상의 원리: 산호는 광합성을 하는 공생 조류와 함께 살아가는데, 수온이 일정 수준 이상으로 오르면 스트레스로 인해 공생 조류를 몸 밖으로 내쫓습니다. 이로 인해 산호는 에너지원과 색을 잃고 하얗게 변색되며, 이것이 바로 백화 현상입니다. 백화가 지속되면 산호가 죽게 됩니다.
            </li>
            <li><b>해양 생태계에 미치는 영향</b><br>
                생물 다양성 위협: 산호초는 전 세계 해양 생물의 약 25%가 서식하는 중요한 서식지입니다. 산호초가 사라지면 수많은 물고기와 무척추동물들의 보금자리가 파괴되고, 이는 곧 해양 생태계 전체의 균형을 무너뜨립니다.<br>
                경제적 손실: 산호초는 어업의 기반을 제공하고, 해안 방파제 역할을 하며, 중요한 관광 자원이 됩니다. 산호초가 붕괴하면 어업 자원 감소, 관광 산업 위축, 해안 침식 등 다양한 사회경제적 피해로 이어집니다. 예를 들어, 2016년 호주 그레이트 배리어 리프의 백화 현상으로 막대한 피해가 발생했으며, 이는 해양 생태계 위기가 인류의 지속 가능한 발전에도 직접적인 위협이 된다는 것을 보여줍니다.
            </li>
            <li><b>시사점 및 실천 방안</b><br>
                온실가스 배출량 감축의 중요성: 산호초 백화 현상의 근본적인 원인은 지구 온난화로 인한 해수온 상승입니다. 따라서 온실가스 배출량을 줄여 기후 변화를 늦추는 것이 가장 중요합니다. 대중교통 이용, 에너지 절약 등 개개인의 작은 실천이 모여 큰 변화를 만들어낼 수 있습니다.<br>
                해양 오염 문제 해결: 플라스틱 쓰레기를 비롯한 해양 오염은 산호초에 추가적인 스트레스를 줍니다. 플라스틱 사용량을 줄이고 해양 정화 활동에 참여하는 것이 중요합니다.<br>
                환경 교육의 강화: 기후 변화와 산호초 백화 현상의 심각성을 알리는 체계적이고 실질적인 환경 교육과 캠페인이 필요합니다. 의무적이고 형식적인 교육을 넘어, 실제로 사람들이 행동 변화를 이끌어낼 수 있는 교육이 이루어져야 합니다.
            </li>
        </ol>
        </div>
        """,
